                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <label className={`relative flex items-center p-4 sm:p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-md ${
                          ...
                          <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 mr-3 sm:mr-4 flex items-center justify-center flex-shrink-0 ${
                            selectedRole === 'student' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                          }`}>
                            {selectedRole === 'student' && (
                        ...
                        <label className={`relative flex items-center p-4 sm:p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-md ${
                          ...
                          />
                          <div className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full border-2 mr-3 sm:mr-4 flex items-center justify-center flex-shrink-0 ${
                            selectedRole === 'faculty' ? 'border-blue-600 bg-blue-600' : 'border-gray-300'
                          }`}>
                            {selectedRole === 'faculty' && (
                              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full" />
                            )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          type="text"
                          id="firstName"
                          className={`w-full px-3 sm:px-4 py-3 sm:py-4 border-2 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-0 focus:border-blue-500 transition-all duration-200 text-sm sm:text-base ${
